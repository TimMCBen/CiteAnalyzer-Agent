...
除非用户明确豁免，只要本轮改动了仓库内容，Agent 必须在结束前依次检查：

1. 是否需要更新 `docs/histories/`
2. 是否属于应先建或补更新 execution plan 的任务
3. 是否涉及 `docs/RELIABILITY.md`、`docs/SECURITY.md`、`docs/SUPPLY_CHAIN_SECURITY.md` 中约束的同步
4. 是否产生了可复用协作经验；如果有，先写入经验池

如果判断“不需要更新”，也应在最终汇报中简短说明原因。
